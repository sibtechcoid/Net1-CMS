...
//        var_dump($fields);exit;
        ...
        return redirect()->route('admin.users.index')->with('response', $response);
    }
    ...
    public function show($id)
    {
        ...
        $res = $this->curl->httpGet(ApiUrl::$url.'users/'. $id);
        ...
        return view('admin.users.show')->with('response', $response)->with('userInfo', User::getSlightInfo());
        // try {
