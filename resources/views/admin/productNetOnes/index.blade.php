        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card border-primary ">
                    ...
                    <a href="{{ route('admin.productNetOnes.create') }}" class="btn btn-sm btn-default"><span
                            class="fa fa-plus"></span> @lang('button.create')</a>
                    </div> --}}
                    <div class="float-right">
                        <a class="btn btn-info" href="{{route('admin.products.download')}}">Export as Excel</a>
                        <a href="{{ route('admin.productNetOnes.reload') }}" class="btn btn-sm btn-default"><span
                                class="fa fa-plus"></span> @lang('Reload')</a>
                    </div>
                </div>
                <br />
                <div class="card-body table-responsive">
                    <form method="POST" enctype="multipart/form-data"
                        action="{{ route('admin.productNetOnes.upload') }}">
                        @csrf
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="productExcel" name="productExcel">
                                <label class="custom-file-label"
                                    for="productExcel">{{ __('excel/form.file-upload-info') }}</label>
                            </div>
