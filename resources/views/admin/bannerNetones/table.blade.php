                ...
                <td>
                    <a href="{{ route('admin.bannerNetones.show', collect($bannerNetone)->first() ) }}">
                        <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA"
                            data-hc="#428BCA" title="view bannerNetone"></i>
                    </a>
                    <a href="{{ route('admin.bannerNetones.edit', collect($bannerNetone)->first() ) }}">
                        <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA"
                            data-hc="#428BCA" title="edit bannerNetone"></i>
                    </a>
                    <a href="{{ route('admin.bannerNetones.confirm-delete', collect($bannerNetone)->first() ) }}"
                        data-toggle="modal" data-target="#delete_confirm"
                        data-id="{{ route('admin.bannerNetones.delete', collect($bannerNetone)->first() ) }}">
                        <i class="livicon" data-name="remove-alt" data-size="18" data-loop="true" data-c="#f56954"
                            data-hc="#f56954" title="delete bannerNetone"></i>
