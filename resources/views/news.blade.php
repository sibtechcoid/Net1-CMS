            ...
            <div class="row">
                    ...
                    <div class="media my-2">
                        ...
                        <div class="media-body">
                            <a href="{{ route('news.show',$item->id) }}" class="text-primary">
                                <strong class="media-heading text-primary">{{ $item->title }}</strong>
                            </a>
                ...
                <div class="col-sm-6 news-body mt-20">
                    ...
                    <div class="sports-height">
                        ...
                        <span class="text-danger small">{!! date('d-m-Y', strtotime($business->first()['created_at']))
                            !!}</span>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_default_1">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object mr-3" src="{{ asset('images/image_13.jpg') }}"
                                            alt="image">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object mr-3" src="{{ asset('images/image_14.jpg') }}"
                                            alt="image">
                                    </a>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img class="media-object mr-3" src="{{ asset('images/image_15.jpg') }}"
                                            alt="image">
                                    </a>
                                </div>
                                <div class="media-body">
