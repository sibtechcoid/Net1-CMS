...
Route::group(
    ...
    function () {
        ...
        Route::post('postSignin', 'AuthController@postSignin')->name('postSignin');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'namespace' => 'Admin' , 'as' => 'admin.'], function() {
    // Dashboard / Index
    Route::get('/', 'AuthController@getDashboard')->name('dashboard');
    Route::get('/modals', 'FrontEndController@getModals');
    Route::get('/sweetalert', 'FrontEndController@getSweetalert');
    Route::get('/tagsinput', 'FrontEndController@getTagsinput');
    Route::get('/toastr', 'FrontEndController@getToastr');
    Route::get('/notifications', 'FrontEndController@getNotifications');
    Route::get('/buttons', 'FrontEndController@getButtons');
});
